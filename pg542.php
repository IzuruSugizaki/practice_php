...
<html>
  <head>
    <meta charset="utf-8">
    <title>２次方程式の解法</title>
  </head>
  <body>
    <h2>2次方程式の解法</h2>
    <p>
      2次方程式ax^2+bx+c=0を解きます。<br>
      係数の値を入力してから解放ボタンを押してください。<br>
      解が複素数のとき、Iは虚数単位を表し、実部が0の場合も表示します。<br>
